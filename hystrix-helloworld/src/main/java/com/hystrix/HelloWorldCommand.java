...
public class HelloWorldCommand extends HystrixCommand<String>{
	 ...
	 private final String name;  
	    ...
	    public static void main(String[] args) throws Exception{  
	        ...
	        rx.Observable<String> fs = new HelloWorldCommand("World").observe(); 
	      //注册结果回调事件  
	        ...
	        //注册完整执行生命周期事件  
	        fs.subscribe(new rx.Observer<String>() {  
	                    @Override  
...
//	    call result=Hello World thread:hystrix-ExampleGroup-3
//	    		onNext: Hello World thread:hystrix-ExampleGroup-3
//	    		execute onCompleted
}
